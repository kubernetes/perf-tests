...
func (d *dnsProgGatherer) IsEnabled(config *measurement.Config) bool {
	return true
}
...
func (d *dnsProgGatherer) Gather(executor QueryExecutor, startTime time.Time, config *measurement.Config) ([]measurement.Summary, error) {
