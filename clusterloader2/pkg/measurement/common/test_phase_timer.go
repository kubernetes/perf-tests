...
const (
	testPhaseTimerMeasurementName = "TestPhaseTimer"
)

func init() {
	measurement.Register(testPhaseTimerMeasurementName, createTestPhaseTimerMeasurment)
}

func createTestPhaseTimerMeasurment() measurement.Measurement {
...
func (t *testPhaseTimer) Execute(config *measurement.MeasurementConfig) ([]measurement.Summary, error) {
...
type testPhaseTimerResult measurementutil.PerfData

// SummaryName returns name of the summary.
func (t *testPhaseTimerResult) SummaryName() string {
	return testPhaseTimerMeasurementName
}

// PrintSummary returns summary as a string.
func (t *testPhaseTimerResult) PrintSummary() (string, error) {
