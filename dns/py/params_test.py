...
class ParamsTest(unittest.TestCase):
    def test_params(self):
        ...
        self.assertEqual('-l,120,-Q,400,-d,/queries/abc', ','.join(
            inputs.dnsperf_cmdline))
    ...
    def test_null_params(self):
        ...
        self.assertEqual('-l,120,-d,/queries/abc', ','.join(
            inputs.dnsperf_cmdline))
    ...
    def test_TestCases_attributes(self):
        ...
        self.assertEqual(0, tc[0].run_subid)
        self.assertEqual("[(<query_file>, 'a')]", str(tc[0].pv))
        self.assertEqual("[(<query_file>, 'b')]", str(tc[1].pv))
        self.assertEqual(1, tc[1].run_subid)
