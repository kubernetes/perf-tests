...
func cleanup(c *kubernetes.Clientset) {
	...
	for _, svc := range svcs.Items {
		...
		c.CoreV1().Services(testNamespace).Delete(context.TODO(),
...
func createServices(c *kubernetes.Clientset) bool {
	...
	if _, err := c.CoreV1().Namespaces().Get(context.TODO(), testNamespace, metav1.GetOptions{}); err != nil {
		c.CoreV1().Namespaces().Create(context.TODO(), &api.Namespace{ObjectMeta: metav1.ObjectMeta{Name: testNamespace}}, metav1.CreateOptions{})
	}
